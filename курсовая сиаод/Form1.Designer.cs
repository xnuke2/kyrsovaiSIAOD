namespace курсовая_сиаод
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            customLabel1.Text = "Алгоритмом определения шага Кнут";
            customLabel2.FromPosition = 20D;
            customLabel2.Text = "Алгоритмом определения шага Вирт";
            customLabel3.FromPosition = 30D;
            customLabel3.Text = "Алгоритмом определения\n шага деление пополам";
            ...
            series1.Name = "Здесь будет отображаться номер сортировки из таблицы";
