...
namespace курсовая_сиаод
{
    ...
    internal class SinglyLlinkedList
    {
        ...
        static SinglyLlinkedList GetRandomUnorderedList(int size)
        {
        ...
        static SinglyLlinkedList GetRandomOrderedList(int size)
        {
            SinglyLlinkedList tmp = new SinglyLlinkedList();
            Random rnd = new Random();
            int last = 0;
        ...
        static SinglyLlinkedList GetRandomOrderedInReverseOrderList(int size)
        {
        ...
        static SinglyLlinkedList GetRandomPartlyOrderedList(int size,int PercentOfOrder)
        {
            SinglyLlinkedList tmp = new SinglyLlinkedList();
            Random rnd = new Random();
            int last = 0;
